...
// SVG Icons - Teacher Assistant Theme
...
const ClassIcon = ({ size = 24, color = '#A060FF' }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
const QuizIcon = ({ size = 24, color = '#A060FF' }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
const StudentsIcon = ({ size = 24, color = '#A060FF' }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
const BottomTab: React.FC<BottomTabProps> = ({ navigation, currentRoute, useSafeArea = true }) => {
  ...
  const getIconColor = (routeName: string) => {
    return currentRoute === routeName ? '#A060FF' : '#999999';
  };
  ...
  const tabContent = (
    <View style={styles.bottomNav}>
      <Pressable 
        ...
        android_ripple={{ color: 'rgba(160,96,255,0.1)', borderless: true }}
      >
